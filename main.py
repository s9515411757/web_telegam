...
def start_fun(message):
   bot.send_message( message.chat.id, 'Ну здарова, ебать! Это мои тестовые страницы. Автор Ершов', parse_mode="Markdown", reply_markup=webAppKeyboard()) #отправляем сообщение с нужной клавиатурой
